...
CREATE TABLE BASKET(
    ...
    DT_CREATED DATETIME NOT NULL,   
    FK_PROMOTION_CODE VARCHAR(255),  
    FK_USER_ID INT NOT NULL,
    FOREIGN KEY (FK_USER_ID) REFERENCES USERS (ID),
    FOREIGN KEY (FK_STATUS_BASKET) REFERENCES BASKET_STATUS(ID),
    FOREIGN KEY (FK_PROMOTION_CODE) REFERENCES PROMOTIONS (DISCOUNT_CODE)
);
INSERT INTO BASKET (FK_STATUS_BASKET, DT_CREATED, FK_PROMOTION_CODE, FK_USER_ID) VALUES (1,  NOW(), 'PROMOCODE01', 1);
INSERT INTO BASKET (FK_STATUS_BASKET, DT_CREATED, FK_PROMOTION_CODE, FK_USER_ID) VALUES (2,  NOW(), NULL, 2);
INSERT INTO BASKET (FK_STATUS_BASKET, DT_CREATED, FK_PROMOTION_CODE, FK_USER_ID) VALUES (3,  NOW(), NULL ,1);
...
INSERT INTO ITEMS_BASKET (FK_PRODUCT_ID, QUANTID, PRICE,  FK_BASKET_ID, DT_CREATED) VALUES (1, 4, 10.00, 1,NOW());
INSERT INTO ITEMS_BASKET (FK_PRODUCT_ID, QUANTID, PRICE,  FK_BASKET_ID, DT_CREATED) VALUES (1, 1, 10.00, 1,NOW());
INSERT INTO ITEMS_BASKET (FK_PRODUCT_ID, QUANTID, PRICE,  FK_BASKET_ID, DT_CREATED) VALUES (1, 2, 10.00, 1,NOW());
INSERT INTO ITEMS_BASKET (FK_PRODUCT_ID, QUANTID, PRICE,  FK_BASKET_ID, DT_CREATED) VALUES (1, 3, 10.00, 1,NOW());
...
INSERT INTO PAYMENT_STATUS (DESCR) values ('ACTIVE');
INSERT INTO PAYMENT_STATUS (DESCR) values ('PENDING');
INSERT INTO PAYMENT_STATUS (DESCR) values ('ACCEPTED');
INSERT INTO PAYMENT_STATUS (DESCR) values ('BLOCKED');
...
INSERT INTO ITENS_SALES (FK_PRODUCT_ID, QUANTID, PRICE, FK_PROMOTION_CODE, FK_BASKET_ID, DT_CREATED) VALUES (1, 4, 10.00, 'PROMOCODE02', 1,NOW());
INSERT INTO ITENS_SALES (FK_PRODUCT_ID, QUANTID, PRICE, FK_PROMOTION_CODE, FK_BASKET_ID, DT_CREATED) VALUES (2, 1, 10.00, 'PROMOCODE02', 1,NOW());
INSERT INTO ITENS_SALES (FK_PRODUCT_ID, QUANTID, PRICE, FK_PROMOTION_CODE, FK_BASKET_ID, DT_CREATED) VALUES (3, 2, 10.00, 'PROMOCODE02', 1,NOW());
INSERT INTO ITENS_SALES (FK_PRODUCT_ID, QUANTID, PRICE, FK_PROMOTION_CODE, FK_BASKET_ID, DT_CREATED) VALUES (1, 3, 500.00, 'PROMOCODE02', 1,NOW());
...
CREATE TABLE SALES(
    ...
    FK_ITENS_SALES INT NOT NULL,
    TOTAL DOUBLE NOT NULL,
    FOREIGN KEY (FK_PAYMENT_TYPE) REFERENCES PAYMENT_TYPE(ID),
    FOREIGN KEY (FK_STATUS_PAYMENT) REFERENCES PAYMENT_STATUS (ID),
    FOREIGN KEY (FK_ITENS_SALES) REFERENCES ITENS_SALES(ID)
);

INSERT INTO SALES (DT_PAYMENT, FK_PAYMENT_TYPE, FK_STATUS_PAYMENT,  DT_CREATED, DT_AUTHORIZED, AUTHORIDED_CODE, FK_ITENS_SALES, TOTAL) VALUES (NOW(), 1, 1, NOW(), NULL, NULL, 1, 1000.00);

-- WHEN PAYMENT HAS BEEN COMPLETED
UPDATE SALES SET AUTHORIDED_CODE = 'AUTH001', DT_AUTHORIZED = NOW(), FK_STATUS_PAYMENT = 3  WHERE ID = 1;
